...
all: all-examples
	...
	cp -f $(BUILD_DIR)/examples/udp-multi-echo  $(BINDIR)/examples/rust/udp-multi-echo.$(EXEC_SUFFIX)
	...
	cp -f $(BUILD_DIR)/examples/tcp-multi-echo  $(BINDIR)/examples/rust/tcp-multi-echo.$(EXEC_SUFFIX)
...
clean:
	...
	@rm -rf $(BINDIR)/examples/rust/udp-multi-echo.$(EXEC_SUFFIX)
	@rm -rf $(BINDIR)/examples/rust/tcp-dump.$(EXEC_SUFFIX)
	@rm -rf $(BINDIR)/examples/rust/tcp-echo.$(EXEC_SUFFIX)
	@rm -rf $(BINDIR)/examples/rust/tcp-multi-echo.$(EXEC_SUFFIX)
